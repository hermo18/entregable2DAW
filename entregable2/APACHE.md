...
## 3. CONLUSIÓN
Para concluir, en mi opinión, aún estando explicado detalladamente todo el proceso de instalación y confiuguración de Apache, puede llegar a ser algo engorroso para un usuario medio, por lo tanto solo recomiendo realizar esto si eres un usuario avanzado y sabes solucionar problemas dentro del entorno de Linux, si no es ese el caso, recomiendop la instalación de algún paquete como **XAMP** que incluyé todo lo que vamos a necesitar para el servidor de nuestra modesta web.
